...
void MetadataController::handleEditAudio(const std::string& filepath,const std::string& ID) {
    ...
    do {
        Exception_Handler("Enter your choice: ",editChoice,validatePosInteger);
        switch(editChoice)
        {
